...
KERNEL_FLAGS = -O3 -munaligned-access -fgcse-sm -fgcse-las -fsched-spec-load -fforce-addr -ffast-math -fsingle-precision-constant -mcpu=cortex-a53 -mtune=cortex-a53 -marm -mfpu=neon-vfpv4 -ftree-vectorize -mvectorize-with-neon-quad -funroll-loops -ftree-loop-im -ftree-loop-ivcanon -fmodulo-sched -fmodulo-sched-allow-regmoves -fivopts -fopenmp -fopenmp-simd -fsimd-cost-model=unlimited -fgraphite -floop-nest-optimize
...
# LINARO OPT
#
CFLAGS_A53 	= -mcpu=cortex-a53 -mtune=cortex-a53 -mfpu=neon-vfpv4 -ffast-math -fgcse-las -marm
CFLAGS_MODULO 	= -fmodulo-sched -fmodulo-sched-allow-regmoves
KERNEL_MODS = $(CFLAGS_A53) $(CFLAGS_MODULO)
